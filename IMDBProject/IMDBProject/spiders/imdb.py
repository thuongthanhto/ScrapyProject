...
class ImdbSpider(scrapy.Spider):
	...
	start_urls = ['http://www.imdb.com/search/title?release_date=2011','http://www.imdb.com/search/title?release_date=2012']

	def parse(self, response):
		# flow link title film
		for href in response.css('div.lister-item-content h3 a::attr(href)').extract():
			yield scrapy.Request(response.urljoin(href), callback=self.parse_movies)
